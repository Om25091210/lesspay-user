...
import com.cu.crazypocket.databinding.ActivityMainBinding
        ...
        binding.nextContinue.setOnClickListener(View.OnClickListener {
           if(binding.edtPhoneNo.text.isEmpty())
           {
               ...
               if(!b)
               {
                   ...
                   userRef.orderByChild("contact").equalTo(binding.edtPhoneNo.text.toString()).addValueEventListener(object : ValueEventListener {
            ...
            when (v.id) {
                ...
                R.id.btndel -> {
                    if (phoneNo != null && phoneNo.isNotEmpty())
                    {
                        ...
                        binding.nextContinue.setBackgroundColor(binding.edtPhoneNo.context.resources.getColor(
                            R.color.gastos_Greyc
                        ))
                    }
                    binding.edtPhoneNo.setText(phoneNo)
                }
